    ...
    <footer className="border-t bg-background">
      <div className="container px-4 py-12 md:py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2 md:col-span-1">
            <Link to="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-xl">CredVerse</span>
            </Link>
            <p className="text-sm text-muted-foreground">
              Decentralized skill verification platform powered by blockchain technology.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link to="/issuers" className="hover:text-primary">For Issuers</Link></li>
              <li><Link to="/verification" className="hover:text-primary">Verify Credentials</Link></li>
        ...
        <div className="border-t mt-12 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} CredVerse. All rights reserved.
          </p>
